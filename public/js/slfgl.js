(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.slfgl = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
SLFGL.prototype = {
    ...
    programs:{points   :{active:false,vertexSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\n#define PI 3.1415926535897932384626433832795\nattribute vec3 a_pos;\nattribute float a_data;\n// attribute vec4 a_color;\n\nuniform vec2 u_minmax;\nuniform float worldSize;\n\nuniform mat4 u_matrix;\n// uniform mat4 v_matrix;\n    \n// varying vec4 vColor;\nvarying float fValue;\n\nfloat lngX(float lng) {\n  return  (180.0 + lng) * worldSize / 360.0;\n}\nfloat latY(float lat) {\n  float y = 180.0 / PI * log(tan(PI / 4.0 + lat * PI / 360.0));\n  return (180.0 -y) * worldSize / 360.0;\n}\n\nfloat divider = 1.0 / abs(u_minmax[1]-u_minmax[0]);\n\nvoid main() {\n  // gl_Position = u_matrix * v_matrix * vec4(a_pos, 1.0);\n  gl_Position = u_matrix * vec4(lngX(a_pos[0]),latY(a_pos[1]),a_pos[2], 1.0);\n  gl_PointSize = 10.0;\n  // vColor = a_color;\n  \n  fValue = (a_data-u_minmax[0]) * divider ;\n}"]),fragmentSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\nuniform sampler2D u_color_ramp;\n\n// varying vec4 vColor;\nvarying float fValue;\n\nconst float divider = 5.0;\nconst float scale = 1.0 / divider;\n\nvoid main() {\n  // gl_FragColor =  vColor;\n  // gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n  // color ramp is encoded in a 16x16 texture\n  // float color = floor(fValue * divider) * scale;\n  float dist = distance( gl_PointCoord, vec2(0.5) );\n  if (dist > 0.5)\n    discard;\n  float color = fValue;\n  vec2 ramp_pos = vec2(\n        fract(32.0 * color),\n        floor(32.0 * color) / 32.0);\n  \n  gl_FragColor = texture2D(u_color_ramp, ramp_pos);\n  \n  \n  \n}"]),mode:'POINTS'},
              wireframe:{active:false,vertexSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\n#define PI 3.1415926535897932384626433832795\nattribute vec3 a_pos;\nattribute float a_data;\n// attribute vec4 a_color;\n\nuniform vec2 u_minmax;\nuniform float worldSize;\n\nuniform mat4 u_matrix;\n// uniform mat4 v_matrix;\n    \n// varying vec4 vColor;\nvarying float fValue;\n\nfloat lngX(float lng) {\n  return  (180.0 + lng) * worldSize / 360.0;\n}\nfloat latY(float lat) {\n  float y = 180.0 / PI * log(tan(PI / 4.0 + lat * PI / 360.0));\n  return (180.0 -y) * worldSize / 360.0;\n}\n\nfloat divider = 1.0 / abs(u_minmax[1]-u_minmax[0]);\n\nvoid main() {\n  // gl_Position = u_matrix * v_matrix * vec4(a_pos, 1.0);\n  gl_Position = u_matrix * vec4(lngX(a_pos[0]),latY(a_pos[1]),a_pos[2], 1.0);\n  \n  // vColor = a_color;\n  \n  fValue = (a_data-u_minmax[0]) * divider ;\n}"]),fragmentSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\nuniform sampler2D u_color_ramp;\n\n// varying vec4 vColor;\nvarying float fValue;\n\nconst float divider = 5.0;\nconst float scale = 1.0 / divider;\n\nvoid main() {\n  // gl_FragColor =  vColor;\n  // gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n  // color ramp is encoded in a 16x16 texture\n  // float color = floor(fValue * divider) * scale;\n  float color = fValue;\n  vec2 ramp_pos = vec2(\n        fract(32.0 * color),\n        floor(32.0 * color) / 32.0);\n  \n  gl_FragColor = texture2D(u_color_ramp, ramp_pos);\n}"]),mode:'LINES'},
              surface  :{active:true,vertexSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\n#define PI 3.1415926535897932384626433832795\nattribute vec3 a_pos;\nattribute float a_data;\n// attribute vec4 a_color;\n\nuniform vec2 u_minmax;\nuniform float worldSize;\n\nuniform mat4 u_matrix;\n// uniform mat4 v_matrix;\n    \n// varying vec4 vColor;\nvarying float fValue;\n\nfloat lngX(float lng) {\n  return  (180.0 + lng) * worldSize / 360.0;\n}\nfloat latY(float lat) {\n  float y = 180.0 / PI * log(tan(PI / 4.0 + lat * PI / 360.0));\n  return (180.0 -y) * worldSize / 360.0;\n}\n\nfloat divider = 1.0 / abs(u_minmax[1]-u_minmax[0]);\n\nvoid main() {\n  // gl_Position = u_matrix * v_matrix * vec4(a_pos, 1.0);\n  gl_Position = u_matrix * vec4(lngX(a_pos[0]),latY(a_pos[1]),a_pos[2], 1.0);\n  \n  // vColor = a_color;\n  \n  fValue = (a_data-u_minmax[0]) * divider ;\n}"]),fragmentSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\nuniform sampler2D u_color_ramp;\n\n// varying vec4 vColor;\nvarying float fValue;\n\nconst float divider = 5.0;\nconst float scale = 1.0 / divider;\n\nvoid main() {\n  // gl_FragColor =  vColor;\n  // gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n  // color ramp is encoded in a 16x16 texture\n  // float color = floor(fValue * divider) * scale;\n  float color = fValue;\n  vec2 ramp_pos = vec2(\n        fract(32.0 * color),\n        floor(32.0 * color) / 32.0);\n  \n  gl_FragColor = texture2D(u_color_ramp, ramp_pos);\n}"]),mode:'TRIANGLES'},
              contours :{active:false,vertexSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\n#define PI 3.1415926535897932384626433832795\nattribute vec3 a_pos;\nattribute float a_data;\n// attribute vec4 a_color;\n\nuniform vec2 u_minmax;\nuniform float worldSize;\n\nuniform mat4 u_matrix;\n// uniform mat4 v_matrix;\n    \n// varying vec4 vColor;\nvarying float fValue;\n\nfloat lngX(float lng) {\n  return  (180.0 + lng) * worldSize / 360.0;\n}\nfloat latY(float lat) {\n  float y = 180.0 / PI * log(tan(PI / 4.0 + lat * PI / 360.0));\n  return (180.0 -y) * worldSize / 360.0;\n}\n\nfloat divider = 1.0 / abs(u_minmax[1]-u_minmax[0]);\n\nvoid main() {\n  // gl_Position = u_matrix * v_matrix * vec4(a_pos, 1.0);\n  gl_Position = u_matrix * vec4(lngX(a_pos[0]),latY(a_pos[1]),a_pos[2], 1.0);\n  \n  // vColor = a_color;\n  \n  fValue = (a_data-u_minmax[0]) * divider ;\n}"]),fragmentSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\nuniform sampler2D u_color_ramp;\n\n// varying vec4 vColor;\nvarying float fValue;\n\nconst float divider = 5.0;\nconst float scale = 1.0 / divider;\n\nvoid main() {\n  // gl_FragColor =  vColor;\n  // gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n  // color ramp is encoded in a 16x16 texture\n  // float color = floor(fValue * divider) * scale;\n  float color = fValue;\n  vec2 ramp_pos = vec2(\n        fract(32.0 * color),\n        floor(32.0 * color) / 32.0);\n  \n  gl_FragColor = texture2D(u_color_ramp, ramp_pos);\n}"]),mode:'TRIANGLES'},
              contoursL:{active:false,vertexSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\n#define PI 3.1415926535897932384626433832795\nattribute vec3 a_pos;\nattribute float a_data;\n// attribute vec4 a_color;\n\nuniform vec2 u_minmax;\nuniform float worldSize;\n\nuniform mat4 u_matrix;\n// uniform mat4 v_matrix;\n    \n// varying vec4 vColor;\nvarying float fValue;\n\nfloat lngX(float lng) {\n  return  (180.0 + lng) * worldSize / 360.0;\n}\nfloat latY(float lat) {\n  float y = 180.0 / PI * log(tan(PI / 4.0 + lat * PI / 360.0));\n  return (180.0 -y) * worldSize / 360.0;\n}\n\nfloat divider = 1.0 / abs(u_minmax[1]-u_minmax[0]);\n\nvoid main() {\n  // gl_Position = u_matrix * v_matrix * vec4(a_pos, 1.0);\n  gl_Position = u_matrix * vec4(lngX(a_pos[0]),latY(a_pos[1]),a_pos[2], 1.0);\n  \n  // vColor = a_color;\n  \n  fValue = (a_data-u_minmax[0]) * divider ;\n}"]),fragmentSource:glsl(["precision mediump float;\n#define GLSLIFY 1\n\nuniform sampler2D u_color_ramp;\n\n// varying vec4 vColor;\nvarying float fValue;\n\nconst float divider = 5.0;\nconst float scale = 1.0 / divider;\n\nvoid main() {\n  // gl_FragColor =  vColor;\n  // gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n\n  // color ramp is encoded in a 16x16 texture\n  // float color = floor(fValue * divider) * scale;\n  float color = fValue;\n  vec2 ramp_pos = vec2(\n        fract(32.0 * color),\n        floor(32.0 * color) / 32.0);\n  \n  gl_FragColor = texture2D(u_color_ramp, ramp_pos);\n}"]),mode:'TRIANGLES'},
             },
    },
...
},{"../../slf-js/src/slf.js":6,"./util":3,"glslify":1}],3:[function(require,module,exports){
...
},{"./bufferpack":5,"./util":7}],7:[function(require,module,exports){
'use strict';
