...
const meshvert = glsl.file('./shaders/mesh.vert.simple.glsl');
const meshfrag = glsl.file('./shaders/mesh.frag.simple.glsl');
...
SLFGL.prototype = {
  ...
  initialisedBuffer:function(){
    ...
    this.XYBuffer      = util.createArrayBuffer(gl, slf.cal);
